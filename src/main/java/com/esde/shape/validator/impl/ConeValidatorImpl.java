package com.esde.shape.validator.impl;

import com.esde.shape.entity.Point;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

public class ConeValidatorImpl implements com.esde.shape.validator.ConeValidator {
    private final Logger logger = LoggerFactory.getLogger(ConeValidatorImpl.class);
    ...
    @Override
    public boolean isPointValid(Point p1, Point p2) {
